...
// Date:            2012-09-06 15:14:25
// Author:          autogen 
// Note:            this is a auto-generated file, DON'T MODIFY IT!
//                  created by lijianhui
//---------------------------------------------------------------------------*/
...
public:
    ...
    ~SMpcsMessage() { }
    SMpcsMessage(const string&  strFromId, const uint8_t&  chType, const string &  strMessage, const int64_t&  llSendTime, const uint64_t&  ullMsgId= 0)
    {
        m_fromId = strFromId;
        m_type = chType;
...
public:
    ...
    ~SRoomInfo() { }
    SRoomInfo(const string&  strRoomName, const string&  strPassword, const int64_t&  llMemberTimes, const VECTOR< SRoomUserInfo >&  vecMemberList, const int64_t&  llLastMsgTimes, const VECTOR< SMpcsMessage >&  vecMessages, const int64_t&  llMsgTimes= 0)
    {
